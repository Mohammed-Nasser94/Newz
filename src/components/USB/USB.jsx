...
export default function USB() {
  ...
  const getUsbNews = async () => {
    try {
      const response = await axios.get(
        "https://newsapi.org/v2/top-headlines?country=us&category=business&apiKey=e551f87d9aa64513a38a98d096808d9e"
      );
      console.log(response.data.articles);
      setUsb(response.data.articles);
    } catch (error) {
              ...
              >
                <a href={n.url}>
                  <img
                    src={
                      n.urlToImage ||
                      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQOGJVPiBaSAd3SRucoPPS1bRCQWjoLvEb2uw&s"
                    }
                    alt={n.title}
